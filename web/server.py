...
def main():
    parser = argparse.ArgumentParser(description="Inicia el servidor Web y API de QuantVibe")
    parser.add_argument(
        "--host",
    ...
    print("==================================================")
    print("  QUANTVIBE TERMINAL -- Servidor Web & API")
    print(f"  Host: {args.host}:{args.port}")
    print(f"  Codespaces / Web URL: http://localhost:{args.port}")
