  ...
  return (
    <div className="relative w-full">
      ...
      <section className="relative flex flex-col items-center text-center pb-20 pt-8 sm:pt-12 lg:pb-28 overflow-hidden">
        {/* Apple & GetLayers Atmospheric Ambient Depth (Vesper / Clarix) */}
        <div
          className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 w-[1100px] h-[600px] bg-gradient-to-b from-emerald-500/[0.045] via-blue-500/[0.02] to-transparent blur-[160px] -z-10"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute -top-32 left-1/2 -translate-x-1/2 w-[650px] h-[360px] bg-white/[0.035] blur-[120px] -z-10"
          aria-hidden
        />

        {/* Asymmetric Luxury Pill Badge with Specular Rim Light */}
        <motion.div
          initial={{ opacity: 0, y: -16 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
          className="specular-rim inline-flex items-center space-x-3 px-4 py-1.5 rounded-full bg-[#0E0E12]/90 border border-white/[0.12] backdrop-blur-2xl shadow-xl mb-6 group hover:border-white/30 transition-colors"
        >
