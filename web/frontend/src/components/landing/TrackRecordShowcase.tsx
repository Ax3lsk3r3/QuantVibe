  ...
  return (
    <div className="w-full py-12">
      <div className="rounded-3xl bg-[#090D16]/90 border border-white/[0.08] p-6 sm:p-8 lg:p-10 backdrop-blur-2xl relative overflow-hidden">
        {/* Subtle glow */}
        <div className="absolute top-1/2 left-1/3 w-80 h-80 bg-blue-500/10 blur-[120px] pointer-events-none" />

        {/* Section Title */}
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-xs font-mono mb-2">
          ...
          <div className="flex items-center space-x-4 text-xs font-mono">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white font-semibold">QuantVibe Alpha (+36.2%)</span>
            </div>
            <div className="flex items-center space-x-2">
              <span className="w-3 h-1 rounded-full bg-slate-500" />
              <span className="text-slate-400">S&P 500 (+13.8%)</span>
            </div>
          </div>
        </div>

        {/* Interactive SVG Chart */}
        <div className="relative w-full overflow-hidden bg-white/[0.01] rounded-2xl border border-white/[0.06] p-4">
          <svg
          ...
          {hoveredPoint && (
            <motion.div
              ...
              className="absolute top-4 right-4 bg-[#0A0F1D]/90 border border-cyan-500/40 rounded-xl p-3 shadow-xl backdrop-blur-xl text-xs font-mono space-y-1 z-20"
            >
              <div className="flex items-center space-x-2 text-white font-bold pb-1 border-b border-white/[0.08]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mt-6 pt-6 border-t border-white/[0.06]">
          <div className="p-3.5 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
            <span className="text-[11px] text-slate-400 block mb-1">Alpha Anualizado</span>
            <span className="text-lg font-bold text-emerald-400 font-mono">+28.4%</span>
            <span className="text-[9px] text-slate-500 block">vs +11.2% benchmark</span>
          </div>
          ...
          <div className="p-3.5 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
            ...
            <span className="text-[9px] text-emerald-400 block">Excelente (&gt; 2.0)</span>
          </div>
          ...
          <div className="p-3.5 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
            ...
            <span className="text-[9px] text-slate-500 block">S&P 500: -19.4%</span>
          </div>

          <div className="p-3.5 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
            <span className="text-[11px] text-slate-400 block mb-1">Win Rate</span>
            <span className="text-lg font-bold text-cyan-400 font-mono">64.2%</span>
            <span className="text-[9px] text-slate-500 block">En operaciones cerradas</span>
          </div>
          ...
          <div className="p-3.5 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
            ...
            <span className="text-[9px] text-slate-500 block">Gross Profit / Loss</span>
          </div>

          <div className="p-3.5 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
            <span className="text-[11px] text-slate-400 block mb-1">Auditoría SQLite</span>
            <span className="text-lg font-bold text-emerald-400 font-mono flex items-center space-x-1">
              <Database className="w-4 h-4 text-emerald-400" />
              <span>100%</span>
            </span>
            <span className="text-[9px] text-slate-500 block">Ledger local inmutable</span>
          </div>
        </div>
      </div>
    </div>
