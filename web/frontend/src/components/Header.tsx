      ...
      <div className="mx-auto max-w-[1780px] px-4 sm:px-6 lg:px-8 xl:px-10">
        <div className="flex h-16 items-center justify-between gap-6">
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            {/* GitHub Repository Direct Link */}
            <a
              href="https://github.com/Ax3lsk3r3/QuantVibe"
              target="_blank"
              rel="noopener noreferrer"
              title="Repositorio oficial en GitHub (Código abierto & CI/CD)"
              aria-label="Ver repositorio en GitHub"
              className="apple-press flex items-center gap-2 rounded-full border border-white/[0.1] bg-white/[0.04] px-3 py-1.5 text-xs font-medium text-[#D2D2D7] transition-all hover:border-white/25 hover:bg-white/[0.08] hover:text-white"
            >
